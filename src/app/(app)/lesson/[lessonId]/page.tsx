            ...
            <div className="lg:col-span-2">
                ...
                <Card className="mt-8">
                    ...
                    <CardContent className="prose prose-sm md:prose-base max-w-none dark:prose-invert">
                        <p>
                            In this lesson, we will cover the core concepts of variables and data types in Python. Follow along with the video and the instructions below. This guidance is generated by AI to help you learn effectively.
                        </p>
                        <ol>
